(function(){
	...
	*/
	...
	console.log( text.replace(/Manuel Marques de Sousa/g, 'Douglas Lopes') );
	...
	*/
	...
	console.log( text.replace(/O Centauro de Luvas/g, function( allMatch ) {
		return allMatch.toUpperCase();
	}) );
	...
	*/
	...
	function getMonthNumber( month ) {
		return String( months[ month.toLowerCase() ] );
	}
	...
	*/
	...
	var regexDate = /(\d\d) de ([\w]+) de (\d\d\d\d)/gi;
