(function(){
	...
	*/
	console.log( '\nOperation:' );
	var operation = justMod2Or3.reduce(function( valAcumulado, valAtual ) {
		return ( valAcumulado + 1 ) * valAtual;
	}, 0);
	...
	*/
	console.log( '\nOperation 2:' );
	var operation2 = justMod2Or3.reduceRight(function( valAcumulado, valAtual ) {
		return ( valAcumulado + 1 ) * valAtual;
	}, 0);
	...
	*/
	...
	var nome = [ 'Do', 'u', 'glas' ];
	var reduceP = nome.reduce(function( valAcumulado, valAtual) {
		return valAcumulado + 'P' + valAtual;
	}, '');
	...
	*/
	console.log( '\nInversed Name:' );
	var inversedName = nome.reduceRight(function( valAcumulado, valAtual ) {
		return valAcumulado + valAtual;
	});
