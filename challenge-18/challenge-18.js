(function(){
	...
	*/
	...
	// 	return cpf.replace(/(\d{3})(\d{3})(\d{3})(\d{2})/, function( cpf, group1, group2, group3, group4 ){
	...
	*/
	...
	console.log( strHtml.match( htmlRegex ) );
	...
	*/
	...
	var strHtml = '<div><ul><li></li><li></li><li><span></span></li></ul></div>';
	...
	*/
	...
	var strHtml = '<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>';
	var htmlRegex = /<(\w+)>([^<]+)<\/\w+>/gi;

	console.log( strHtml.replace( htmlRegex, '<$1>O texto dentro da tag "$1" é "$2"</$1>\n' ) );
})();
